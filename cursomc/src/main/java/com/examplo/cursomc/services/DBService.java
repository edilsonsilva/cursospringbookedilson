...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		cli1.getTelefones().addAll(Arrays.asList("2352656", "25445487"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt303", "Jardim", "33521210", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "150", "Sala 800", "Centro", "65214857", cli1, c2);
